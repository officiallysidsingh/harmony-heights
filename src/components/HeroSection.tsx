...
export default function HeroSection() {
  return (
    <div className="bg-gray-800 flex h-72 md:h-[38rem] justify-center items-center flex-col">
      ...
      >
        <div className="w-full h-72 md:h-[38rem] flex flex-col justify-end items-start pb-6 md:pb-14 backdrop-brightness-50">
          <h3
            className={`text-slate-200 text-3xl md:text-7xl pl-4 md:pl-10 ${caveat.className} font-bold antialiased`}
          >
